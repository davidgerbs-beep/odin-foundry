...
- **Nordlicht 1977** (vorerst auf Deutsch): die Gründungskampagne von 1947 bis zur Nacht von Nordlicht. Alle 13 Einsätze als Journale mit Seiten für Briefing, Knoten, Konfrontation und Nachspiel, dazu Epochenregeln, Figuren der Zeit, Zwischenjahre, Die Nacht und Nach Nordlicht. Die zwölf Karten K1 bis K12 als Szenen mit einer Notiz an jedem nummerierten Ort (auf der Europakarte an jedem Einsatzort), die 57 Handouts als Bildseiten im passenden Einsatz (zum Zeigen an die Spieler), 31 Gegner mit Werten und die sechs fertigen Agenten aus Anhang A je als Fassung 1947 und 1977, alle mit eigenem Porträt.
