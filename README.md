...
- **Erfahrung und Steigern** nach Änderungsliste 3: EP gibt es nach jeder Mission, das Makro „EP nach der Mission“ rechnet Aktenfarbe, Missionsziel, Fäden und persönlichen Bonus und schreibt alles in die Laufbahn. Vorhandene Fertigkeiten und Knoten steigen sofort; eine neue Fertigkeit braucht Trainieren mit einem Lehrer, ein Attribut die ganze Zwischenzeit (höchstens eines pro Zwischenzeit). Kosten: Attribut neuer Wert × 5, Fertigkeit neuer Wert × 2, neue Fertigkeit 3.
- **Kompendien**: zehn fertige Agenten mit Porträts (Grundregelwerk und Schnellstart), Waffen, Rüstungen, Ausrüstung und Artefakte, das komplette Arsenal, Psi-Kräfte und Zauber (mit den acht mächtigen Kräften und zehn Schulzaubern aus Schattenoffiziere) und der Bedrohungsatlas mit Bildern. Dazu die Abenteuer als Journale mit Karten, Handouts und verlinkten Gegnern: Nexus-Splitter, Das Haus am Stausee, die acht Grauen Akten, die Kampagne Die Tür mit 24 Missionen, Die anderen Dienste mit 16 Dossiers, Horte der Welt mit neun Stützpunkten, die Zufallsakten und die Kampagne Nordlicht 1977.
- **Abenteuer mit einem Klick**: Schnellstart, Graue Akten, Die Tür, Die anderen Dienste, Horte der Welt, Zufallsakten und Nordlicht 1977 als Abenteuerpakete. Ein Import legt Journale, Gegner, Szenen, Würfeltabellen, Makros und Ordner in der Welt an, alle Verweise bleiben erhalten.
- **Horte der Welt**: alle neun Horte von London bis Cusco mit Geschichte, Tarnung, Leuten, Gerüchten und Aufhängern, die Grundrisse als Szenen mit einer Notiz an jedem nummerierten Raum, dazu Archive, Relais und Werkstätten sowie Regionen und Reisen. Die 66 Leute aus den Horten und Archiven liegen als verbündete Figuren mit eigenem Porträt, Rolle und Beschreibung bereit, ihre Namen im Journal öffnen den Bogen.
- **Zufallsakten**: 113 Würfeltabellen aus dem Band (Akten, Orte, Leute, das Unerklärliche, Hinweise, Zeit zwischen den Akten, Grauen am Tisch) und vier Makros: Die Akte in zehn Würfen, Eine Figur in vier Würfen, Ein Kult in fünf Würfen, Ein Artefakt in fünf Würfen. Jedes Makro würfelt alles nacheinander und schickt der Spielleitung eine Chatkarte. Aktennamen folgen der Regel des Bandes: Das zweite Wort bleibt in der Zehnerreihe des ersten, damit Artikel und Wort zusammenpassen.
- **Nordlicht 1977** (Deutsch und Englisch): die Gründungskampagne von 1947 bis zur Nacht von Nordlicht. Alle 13 Einsätze als Journale mit Seiten für Briefing, Knoten, Konfrontation und Nachspiel, dazu Epochenregeln, Figuren der Zeit, Zwischenjahre, Die Nacht und Nach Nordlicht. Die zwölf Karten K1 bis K12 als Szenen mit einer Notiz an jedem nummerierten Ort (auf der Europakarte an jedem Einsatzort), die 57 Handouts als Bildseiten im passenden Einsatz (zum Zeigen an die Spieler), 31 Gegner mit Werten und die sechs fertigen Agenten aus Anhang A je als Fassung 1947 und 1977, alle mit eigenem Porträt.
- **Szenen**: die neun Grundrisse der Horte und die acht Karten der Grauen Akten als spielfertige Szenen mit Notizen auf allen nummerierten Orten (ein Klick öffnet die Karte im Journal), die zwölf Karten von Nordlicht 1977 mit Notizen, dazu Stimmungsbilder für den Schnellstart und alle Missionen der Tür. Die Abenteuer-Journale verlinken ihre Szenen.
...
- **Proben** mit zwei Würfelfarben: weiße Würfel (Attribut) ab 5, bunte Würfel (Fertigkeit) ab 4. Dialog mit Attribut, Fertigkeit, Schwierigkeit, Bonus- und Maluswürfeln. Chatkarte mit Erfolgen, Überschuss, Patzer und grandiosem Erfolg. Mit Dice So Nice rollen die O.D.I.N.-Würfel: weiß für das Attribut, bunt in der Farbe der Klasse.
- **Kampf**: Angriff gegen das markierte Ziel, Schaden = Waffe + Überschuss − Rüstung (Durchschlag berücksichtigt), direkt auf die Lebenspunkte oder per Knopf durch die Spielleitung. Fällt ein Gegner auf 0 LP, bekommt er den Totenkopf und gilt im Kampf als besiegt. Ein Agent bei 0 LP wird als bewusstlos markiert (abschaltbar). Auch die Initiative rollt mit weißen O.D.I.N.-Würfeln.
...
Sprachen: Deutsch (Standard) und Englisch. Bögen, Klassenbäume, Signaturen, Kompendien, Szenen, Würfeltabellen und Makros gibt es in beiden Sprachen, jeweils mit dem Wortlaut der deutschen bzw. englischen Bücher. „Die anderen Dienste“ und „Nordlicht 1977“ liegen auch auf Englisch vor („The Other Services“, „Nordlicht 1977“ mit englischen Karten und Handouts). Die Kompendienliste zeigt nur die Kompendien der eingestellten Sprache (in den Einstellungen umschaltbar). Der Import nimmt Figuren aus dem deutschen und dem englischen Charaktergenerator an.
...
Grundregelwerk Zweite Edition und Änderungsliste 3. Bei Widersprüchen gelten die Bücher.
